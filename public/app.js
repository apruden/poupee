...
function onPan(ev) {
    ...
    axios.get('/api/v1/browser/mouse', {params: {deltaX: deltaX, deltaY: deltaY} });
...
$('#back').click(() => {
    axios.get('/api/v1/browser/back')
});

$('#forward').click(() => {
    axios.get('/api/v1/browser/forward')
});

$('#enter').click(() => {
    axios.get('/api/v1/browser/enter')
});

$('#escape').click(() => {
    axios.get('/api/v1/browser/escape')
});
